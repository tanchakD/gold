...
if (isset($_POST['submit'])) {
  ...
  $query1 = mysqli_query($con, "insert into tbltracking(OrderId,remark,status) value('$oid','$remark','$ressta')");
  // $query2 = mysqli_query($con, "update orders set Status='$ressta',Remark='$remark' where OrderNumber='$oid'");
  if ($query1) {
        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            <div class="card-body">
              <?php
              $oid = $_GET['orderid'];
              $ret = mysqli_query($con, "select * from orders join users on users.id=orders.UserId where orders.Ordernumber='$oid'");
              $cnt = 1;
